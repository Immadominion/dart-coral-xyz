...
Future<void> _demonstrateErrorHandling() async {
  ...
  try {
    // Example of handling invalid public key
    final invalidKey = 'invalid_key';
    PublicKey.fromBase58(invalidKey);
...
/// Demonstrate basic utilities
Future<void> _demonstrateUtilities() async {
  print('\n🔧 Basic Utilities:');
  ...
  print('System program ID: $pubkey');

  // Address generation (demonstrating the concept)
  print('Address utilities available for PDA generation');
}
